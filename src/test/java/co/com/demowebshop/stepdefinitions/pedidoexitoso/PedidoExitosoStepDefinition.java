package co.com.demowebshop.stepdefinitions.pedidoexitoso;
...
import static co.com.demowebshop.questions.order.SuccessfulOrder.successfulOrder;
import static co.com.demowebshop.tasks.apparelandshoes.AddProductsToCart.addProductsToCart;
import static co.com.demowebshop.tasks.checkout.FillFieldsCheckout.fillFieldsCheckout;
...
import static co.com.demowebshop.tasks.shoppingcart.OpenCheckout.openCheckout;
import static net.serenitybdd.screenplay.GivenWhenThen.seeThat;
import static net.serenitybdd.screenplay.actors.OnStage.theActorInTheSpotlight;
import static org.hamcrest.CoreMatchers.equalTo;

public class PedidoExitosoStepDefinition extends Setup {
    ...
    public void realizeElCheckoutExitosamente() {
        try {
            theActorInTheSpotlight().attemptsTo(
    ...
    public void elSistemaDeberaMostrarElSiguienteMensaje(String message) {
        try {
            theActorInTheSpotlight().should(
                    seeThat(
                            successfulOrder().is(message), equalTo(true)
                    ).orComplainWith(
                            TextDontMatch.class,
